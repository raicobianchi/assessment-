...
public class OfflineExercises {
	...
	public boolean endsDev(String input) {
		boolean endDev = false;
		input = "ihatedev";

		if (input.contains("dev") && input.indexOf()) {
			endDev = true;
			System.out.println("it ends in dev");
		} else if (input != "dev") {
			endDev = false;
